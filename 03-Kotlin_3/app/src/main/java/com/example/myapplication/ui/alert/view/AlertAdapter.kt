...
class AlertAdapter(
    private val onSnoozeClick: (String) -> Unit,
    ...
    inner class AlertViewHolder(private val binding: ItemAlertBinding) :
        ...
        fun bind(item: Alert, onSnoozeClick: (String) -> Unit, onStopClick: (String) -> Unit, onDeleteClick: (String) -> Unit) {
            try {
                ...
                binding.snoozeButton.setOnClickListener { onSnoozeClick(item.id) }
    ...
    override fun onBindViewHolder(holder: AlertViewHolder, position: Int) {
        try {
            ...
            holder.bind(item, onSnoozeClick, onStopClick, onDeleteClick)
        } catch (e: Exception) {
